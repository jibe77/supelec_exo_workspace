...
public class ClientPricesReducer extends Reducer<Text, Text, Text, Text> {
    ...
    protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        for (Text value : values) {
            String[] counterAndPrice = value.toString().split("/");
            int counter = Integer.parseInt(counterAndPrice[0]);
            double price = Double.parseDouble(counterAndPrice[1]);
        ...
        context.write(key, new Text("Médiane: " + mediane + ", Ecart Type: " + ecartType));
    }
